...
describe("NoticeManagementPage", () => {
  ...
  it("creates a notice with the entered text and visibility", () => {
    ...
    fireEvent.change(screen.getByLabelText("공지 문구"), {
  ...
  it("clears the create form and shows a success message once the create mutation succeeds", () => {
    render(<NoticeManagementPage />);
    ...
    expect(screen.getByLabelText("공지 문구")).toHaveValue("");
  ...
  it("edits a notice inline and rejects clearing the text", () => {
    render(<NoticeManagementPage />);
    ...
    const editField = within(row).getByLabelText("공지 문구 수정");
